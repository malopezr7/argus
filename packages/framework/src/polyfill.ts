 ...
 * builds both from `print` and supplies the engine-neutral microtask primitive.
 * Component-only scheduler polyfills live with the component layer so plain
 * suites preserve the standalone engine's native global surface.
 * Dependency-free; no Node/Bun APIs.
 */
